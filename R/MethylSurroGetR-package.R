...
#'   \item{\code{\link{methyl_surro_comp}}}{Example complete \code{methyl_surro} object}
#'   \item{\code{\link{methyl_surro_miss}}}{Example \code{methyl_surro} object with missing data}
#' }
#'
